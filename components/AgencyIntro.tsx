...
export default function AgencyIntro() {
    return (
        <section className="relative w-full py-32 px-6 flex flex-col items-center justify-center text-center bg-[#121212] z-10">

            <div className="flex flex-col md:flex-row gap-6 mb-12">
                {/* Green Badge - ChargeBrize */}
                <motion.div
